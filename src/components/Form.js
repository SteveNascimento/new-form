...
import { Select, Input, Form, Col, Row, Divider, Button, DatePicker, Drawer } from 'antd'
                    ...
                    return (
                        ...
                        >
                            <DatePicker 
                                ...
                                panelRender={(panel) => ( mobile ?
                                    <Drawer visible={drawer} height={350} placement="bottom">
                                        {panel}
                                    </Drawer>
                                    : panel
                                )}
            ...
            >
                <section>
                    ...
                    <Row align="top" gutter={[10, 10]}>
                        <Col>
                            <DatePickerField name='data_matricula' label='Data de matrícula' />
                        </Col>
                        <Col>
